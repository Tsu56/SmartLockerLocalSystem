...
xfce4-terminal \
    ...
    --tab --title="Camera Service" --command="bash -c 'cd /home/tphu/Desktop/SmartLocker/camera_service && source camera_venv/bin/activate && python3 app.py; exec bash'" \
    --tab --title="Camera Sync Agent" --command="bash -c 'cd /home/tphu/Desktop/SmartLocker/camera_service && source camera_venv/bin/activate && python3 camera_sync_agent.py; exec bash'" \
